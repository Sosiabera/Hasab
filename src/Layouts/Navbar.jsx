...
const Navbar =() =>{
  ...
  return (
    <nav className="bg-gradient-to-r from-orange-500 via-orange-400 to-orange-500 text-white">
      <img src="/image/hlogo.JPG" alt="" class="absolute w-12 h-12 rounded-full flex m-2"/>
      <h2 className="absolute text-4xl font-bold">Hasab</h2>
...
>
  ...
  <div class="social-button">
    <button class="relative w-5 h-5 rounded-full group">
      <div
        class="floater w-full h-full absolute top-0 left-0  rounded-full duration-300 group-hover:-top-8 group-hover:shadow-2xl"
      ></div>
      <div
        class="icon relative z-10 w-full h-full flex items-center justify-center  rounded-full"
      >
        <svg
          fill="none"
          viewBox="0 0 22 22"
